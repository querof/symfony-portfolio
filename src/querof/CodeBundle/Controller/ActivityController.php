...
use querof\CodeBundle\Entity\Activity;
...
class ActivityController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $activities = $em->getRepository('querofCodeBundle:Activity')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('querof\CodeBundle\Form\ActivityType', $activity);
    ...
    {
        $deleteForm = $this->createDeleteForm($activity);
        $editForm = $this->createForm('querof\CodeBundle\Form\ActivityType', $activity);
