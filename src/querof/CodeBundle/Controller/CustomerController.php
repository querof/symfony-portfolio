...
use querof\CodeBundle\Entity\Customer;
...
class CustomerController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $customers = $em->getRepository('querofCodeBundle:Customer')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('querof\CodeBundle\Form\CustomerType', $customer);
    ...
    {
        $deleteForm = $this->createDeleteForm($customer);
        $editForm = $this->createForm('querof\CodeBundle\Form\CustomerType', $customer);
